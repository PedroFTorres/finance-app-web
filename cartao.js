...
function initCartaoPage() {
  ...
  const BANK_CATALOG = [
    ...
    { code: 'sicoob', name: 'Sicoob', aliases: ['sicoob'], initials: 'SC', logo: 'assets/banks/sicoob.png?v=20260816-4', color: '#00a091', bg: '#e9fbf8' },
    { code: 'mercadopago', name: 'Mercado Pago', aliases: ['mercado pago', 'mercadopago'], initials: 'MP', logo: 'assets/banks/mercadopago.png?v=20260816-4', color: '#00a7e1', bg: '#e9f8ff' },
    ...
    { code: 'xp', name: 'XP Investimentos', aliases: ['xp', 'xp investimentos'], initials: 'XP', logo: 'assets/banks/xp.png?v=20260816-4', color: '#111827', bg: '#fff7d6' },
