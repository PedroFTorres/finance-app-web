...
// ================================ // FILTRO DE LANÇAMENTOS // ================================
  ...
  const BANK_CATALOG = [
    ...
    { code: 'bradesco', name: 'Bradesco', aliases: ['bradesco'], initials: 'BR', logo: 'assets/banks/bradesco.svg?v=20260816-3', color: '#cc092f', bg: '#fff0f3' },
    { code: 'nubank', name: 'Nubank', aliases: ['nubank', 'nu bank', 'nu'], initials: 'NU', color: '#820ad1', bg: '#f7edff' },
    { code: 'inter', name: 'Inter', aliases: ['inter', 'banco inter'], initials: 'IN', logo: 'assets/banks/inter.svg?v=20260816-3', color: '#ff7a00', bg: '#fff3e6' },
    ...
    { code: 'safra', name: 'Safra', aliases: ['safra', 'banco safra'], initials: 'SF', logo: 'assets/banks/safra.svg?v=20260816-3', color: '#0f3b82', bg: '#edf3ff' },
    { code: 'sicredi', name: 'Sicredi', aliases: ['sicredi'], initials: 'SI', logo: 'assets/banks/sicredi.svg?v=20260816-3', color: '#39a935', bg: '#effaf0' },
    { code: 'sicoob', name: 'Sicoob', aliases: ['sicoob'], initials: 'SC', logo: 'assets/banks/sicoob.svg?v=20260816-3', color: '#00a091', bg: '#e9fbf8' },
    { code: 'mercadopago', name: 'Mercado Pago', aliases: ['mercado pago', 'mercadopago'], initials: 'MP', logo: 'assets/banks/mercadopago.svg?v=20260816-3', color: '#00a7e1', bg: '#e9f8ff' },
    { code: 'picpay', name: 'PicPay', aliases: ['picpay', 'pic pay'], initials: 'PP', logo: 'assets/banks/picpay.svg?v=20260816-3', color: '#21c25e', bg: '#ecfff3' },
    { code: 'xp', name: 'XP Investimentos', aliases: ['xp', 'xp investimentos'], initials: 'XP', logo: 'assets/banks/xp.svg?v=20260816-3', color: '#111827', bg: '#fff7d6' },
